    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" method="POST" action="<?=base_url().'penilaian/alternatif'?>">
        ...
        <div class="panel-body">
          <form name="alternatif_form" method="post" action="<?=base_url().'penilaian/normalisasi/'?>">
...
<div class="col-md-12">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form name="alternatif_form" method="post" action="<?=base_url().'penilaian/rangking/'?>">
